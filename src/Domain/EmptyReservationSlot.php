...
class EmptyReservationSlot
{
    ...
    {
        return new ReservationSlot($this->_beginPeriod->timezone($timezone), $this->_endPeriod->timezone($timezone), $this->date(), $this->periodSpan(), $this->_reservation);
    }
    ...
    {
        return $this->_reservation->isUserParticipating($session->userId) || $this->_reservation->isUserInvited($user->id);
    }
